...
//     console.log(num2)
//   }else if(num1===num2){
//     console.log('the two are same')
//     console.log('num1: ${num1} and num2: ${num2}')
//   }else{
//     console.log('wrong input')
//   }
// }
// compareNums(500,5000)
...
function printAllNames (namesArr1)
...
*/
let sampleEmail = ' ashley.ahamed@gmail.com '
console.log(`${sampleEmail} ${sampleEmail.length}`)
...
function chocolateFrogs (gold){
  ...
  numberOfFrogs = ~~ (gold / 3)

  return numberOfFrogs
}
let totalFrogs = chocolateFrogs (gold)
...
function numSort (num) { 
  ...
  let arrayIsAscending = numSort(sampleArray1)
